...
/**
 * Manages all player-facing messages and notifications for the BeaconsPlus plugin.
 * <p>
...
public class MessageManager {
    ...
    public Component get(String path) {
        return prefixComponent.append(deserialize(path));
    }
    ...
    public Component get(String path, TagResolver... resolvers) {
        return prefixComponent.append(deserialize(path, resolvers));
    }
    ...
    public Component getRaw(String path, TagResolver... resolvers) {
        return deserialize(path, resolvers);
    }
    ...
    private Component deserialize(String path, TagResolver... resolvers) {
